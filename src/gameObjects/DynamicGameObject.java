...
public abstract class DynamicGameObject extends GameObject {
	...
	private double GRAVITATIONAL_ACCELERATION = 1;
	private final double TERMINAL_VELOCITY = 40;
	private final int MAX_X = 960 - 48;
	...
	public int[] getCollisionDirection(GameObject other) {
		...
		double distanceIntoClosestSide = Math.min(Math.min(distanceIntoTop, distanceIntoBottom),
				Math.min(distanceIntoLeft, distanceIntoRight));
